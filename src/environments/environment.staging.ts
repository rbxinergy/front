export const environment = {
  ...
  apiUrls: {
    client: `client-drzcbalp5q-uk.a.run.app/api/v1/role`,
    company: `company-drzcbalp5q-uk.a.run.app/api/v1/contact`,
    contact: `contact-drzcbalp5q-uk.a.run.app/api/v1/company`,
    domain: `domain-drzcbalp5q-uk.a.run.app/api/v1/domain`,
    domainCategory: `domain-category-drzcbalp5q-uk.a.run.app/api/v1/service-category`,
    groupCompany: `group-company-drzcbalp5q-uk.a.run.app/api/v1/group-company`,
    login: `login-drzcbalp5q-uk.a.run.app/api/v1/login/auth/login`,
    logout: `login-drzcbalp5q-uk.a.run.app/api/v1/login/auth/logout`,
    provider: `provider-drzcbalp5q-uk.a.run.app/api/v1/provider`,
    role: `role-drzcbalp5q-uk.a.run.app/api/v1/client`,
    subdomain: `subdomain-drzcbalp5q-uk.a.run.app/api/v1/subdomain`,
    user: `user-drzcbalp5q-uk.a.run.app/api/v1/user`,
